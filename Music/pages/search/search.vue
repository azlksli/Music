		...
		<view class="container">
			<scroll-view scroll-y="true" >
				<view class="search-search">
					<text v-show="searchType != 1" class="iconfont icon-sousuo_huaban1"></text>
				...
				<view class="search-hot">
					...
					<view class="search-hot-item" v-for="(item,index) of searchHot" :key="index" @tap="handleToWord(item.searchWord)">
				...
				<block v-else-if="searchType==2">
					<view class="search-result">
						<view class="search-result-item" v-for="(item,index) of searchList" :key="index" @tap="handleToDetail(item.id)">
				...
				<block v-else-if="searchType==3">
					<view class="search-suggest">
						...
						<view class="search-suggest-item" v-for="(item,index) in searchSuggest" :key="index" @tap="handleToWord(item.keyword)">
							<text class="iconfont icon-sousuo_huaban1"></text> {{item.keyword}}
						</view>
<!-- 						<view class="search-suggest-item">
							<text class="iconfont icon-sousuo_huaban1"></text> 少年
						</view> -->
