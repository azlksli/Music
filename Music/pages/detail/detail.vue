<template>
	<view class="detail">
		...
		<musicHead :title="songDetail.name" :icon="true" color="#fff"></musicHead>
...
<script>
	...
	import {songDetail,songComment,songLyric,songUrl,songSimi} from '../../common/api.js'
	export default {
		components:{
			musicHead
		},
