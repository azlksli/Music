			...
			<scroll-view scroll-y="true" >
				<view class="list-head">
					<view class="list-head-img">
						...
						<text class="iconfont icon-icon-">{{playlist.playCount | formatCount}}</text>
					</view>
...
.list-music{background-color: white; border: 50rpx;margin-top: 40rpx;overflow: hidden;}
.list-music-head{height: 50rpx; margin: 30rpx 0 70rpx 23rpx;}
...
.list-music-song view:nth-child(1){font-size: 28rpx;color: #000000;width: 70vw; white-space: nowrap;overflow: hidden;text-overflow: ellipsis;}
...
.list-music-song view:nth-child(2) image{width: 32rpx;height: 20rpx;margin-right: 8rpx;}
